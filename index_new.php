...
echo html_writer::div('<h1>Selecione uma funcionalidade:</h1>', 'plugin_select_text');

echo html_writer::div('<img src="http://www.datamountain.com/wp-content/uploads/front_laptop.gif" height="100"><h4 class = "nomefuncao">SISTEC</h4>', 'plugin_select_sistec');

echo html_writer::div('<img src="http://www.datamountain.com/wp-content/uploads/front_laptop.gif" alt="Evadidos"><h4 class = "nomefuncao">Evadidos</h4>' , 'plugin_select_evadidos');

echo html_writer::div('<img src="http://www.datamountain.com/wp-content/uploads/front_laptop.gif" alt="CursosVazios"> <h4 class = "nomefuncao">Cursos<br>Vazios</h4>', 'plugin_select_cursosvazios');

echo html_writer::div('<img src="http://www.datamountain.com/wp-content/uploads/front_laptop.gif" alt="Servidores"> <h4 class = "nomefuncao">Servidores</h4>', 'plugin_select_servidores');

echo html_writer::div('<img src="http://www.datamountain.com/wp-content/uploads/front_laptop.gif" alt="Confirmar"> <h4 class = "nomefuncao">Confirmar<br>User</h4>', 'plugin_select_confirmar');
...
<script>
    $( ".plugin_select_sistec" ).click(function () {
        window.location = "https://moodle.ifrs.edu.br/report/sistec/index.php?id='.$id.'";
    });
</script>';*/
